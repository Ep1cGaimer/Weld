...
export function installedBuild() {
    const m = readJson(join(binDir(), "manifest.json"), {});
    return m.build ?? null;
}
...
export function extract(file, dir) {
...
export function writeManifest(extras = {}) {
    ensureWeldHome();
